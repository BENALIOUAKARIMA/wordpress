...
function car_repair_enqueue_styles() {
    ...
    wp_enqueue_style('car-repair-style', get_stylesheet_directory_uri() .'/style.css', array('automobile-hub-style'));

    require get_theme_file_path( '/tp-theme-color.php' );
        wp_add_inline_style( 'car-repair-style',$automobile_hub_tp_theme_css );
...
if ( ! function_exists( 'car_repair_credit' ) ) {
    function car_repair_credit(){
        echo "<a href=".esc_url(CAR_REPAIR_CREDIT)." target='_blank'>".esc_html__('Car Repair WordPress Theme','car-repair')."</a>";
    }
}
